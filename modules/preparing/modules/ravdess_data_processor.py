import os
from  modules.preparing.utils.combine_data_utils import move_file_to_emotion_folder

class RAVDESSDataProcessor:
    """
    Lớp để xử lý dữ liệu RAVDESS, bao gồm việc phân loại và di chuyển các tệp âm thanh
