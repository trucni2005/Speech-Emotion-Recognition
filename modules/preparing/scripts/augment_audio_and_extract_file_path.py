...
class AudioAugmentationAndFilePathExtraction:
    ...
    def _process_file(self, folder, subdirectory_path, output_folder, dataset_type):
        """
    ...
    def _process_folder(self, input_folder, output_folder, dataset_type):
        """
        ...
        for root, dirs, _ in os.walk(input_folder):
            for folder in dirs:
                ...
                file_paths_with_labels = self._process_file(folder, subdirectory_path, output_folder, dataset_type)
    ...
    def process_folders(self, input_folder, output_folder):
        ...
        for dataset_type in ['train', 'validation', 'test']:
            ...
            all_file_paths_with_labels = self._process_folder(_input_folder, _output_folder, dataset_type)
